...
<ol class="breadcrumb">
   <li class="breadcrumb-item"><a style='background: #fff !important;' href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Reports<i class="fa fa-angle-right"></i>Registered Sellers</li>
</ol>
<div class="page-container-fluid">
   <div class="grid-form1">
      ...
      echo "<h4 style='text-align:right'>Number of Accepted Employer found: $number</h4>";  ?>
      <hr>
